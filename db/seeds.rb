...
user_admin = User.create(name: 'An Admin', email: '05bs001@gmail.com', address: '11 julias mead pe111rs spalding',
                         phone: '0746435464', date_of_birth: '20/11/2001', role: role_user_admin)
# Tradesmen owners
user_tradesmen_1_owner = User.create(name: 'N1 Tradesman Owner', email: '05bs002@gmail.com',
                                     ...
                                     date_of_birth: '20/11/2001', role: role_user_tradesman)
...
user_booker_1_owner = User.create(name: 'Owner booker1', email: '05bs005@gmail.com',
                                  ...
                                  date_of_birth: '20/11/2001', role: role_user_booker)
...
user_booker_2_employee = User.create(name: 'Employee booker2', email: '05bs006@gmail.com',
                                      ...
                                      date_of_birth: '20/11/2001', role: role_user_booker)
# Businesses
business_1 = Business.create(name: 'Lettings agent uno', description: 'The first', address: 'adsfsdfadf', phone: '34544335',
                             owner: user_booker_1_owner)
...
TradesmenProfileUser.create(tradesmen_profile: tradesmen_profile_1, user: user_tradesmen_1_owner,
                            role: role_tradesmen_owner)
TradesmenProfileUser.create(tradesmen_profile: tradesmen_profile_1, user: user_tradesmen_1_admin,
                            role: role_tradesmen_admin)
TradesmenProfileUser.create(tradesmen_profile: tradesmen_profile_1, user: user_tradesmen_1_employee,
                            role: role_tradesmen_employee)
TradesmenProfileUser.create(tradesmen_profile: tradesmen_profile_2, user: user_tradesman_2_owner,
                            role: role_tradesmen_owner)
TradesmenProfileUser.create(tradesmen_profile: tradesmen_profile_2, user: user_tradesman_2_admin,
                            role: role_tradesmen_admin)
TradesmenProfileUser.create(tradesmen_profile: tradesmen_profile_2, user: user_tradesmen_2_employee,
                            role: role_tradesmen_employee)

# Tradesmen profile trades
TradesmenProfilesTrades.create(tradesmen_profile: tradesmen_profile_1, tradesmen_trade: tradesmen_trade_plumber)
TradesmenProfilesTrades.create(tradesmen_profile: tradesmen_profile_2, tradesmen_trade: tradesmen_trade_electrician)
TradesmenProfilesTrades.create(tradesmen_profile: tradesmen_profile_2, tradesmen_trade: tradesmen_trade_painter)
